...
class ovsState():
    ...
    def interfaceState(self):
        # ifacedict store interface state in format
        # {interface_uuid:{interface_name, options}}
    ...
    def portState(self):
        # portdict store port and its interface state in format
        # {port_uuid:{port_name, interface_name, options}}
